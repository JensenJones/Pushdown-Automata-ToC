...
class ParsingTable {
    ...
    public ParsingTable() {
        ...
        parsingTable.put(new Pair<>(TreeNode.Label.stat, Token.TokenType.ID), Arrays.asList(
                new Pair<>(TreeNode.Label.assign, null),
                new Pair<>(TreeNode.Label.terminal, Token.TokenType.SEMICOLON)));
        ...
        List<Pair<Symbol, Token.TokenType>> forArithRuleA = Collections.singletonList(
        ...
        List<Pair<Symbol, Token.TokenType>> printRuleA = Arrays.asList(
                ...
                new Pair<>(TreeNode.Label.terminal, Token.TokenType.LPAREN),
                new Pair<>(TreeNode.Label.printexpr, null),
                new Pair<>(TreeNode.Label.terminal, Token.TokenType.RPAREN));
        ...
        parsingTable.put(new Pair<>(TreeNode.Label.expr, Token.TokenType.LPAREN), exprRuleA);
        ...
        List<Pair<Symbol, Token.TokenType>> exprRuleB = Collections.singletonList(new Pair<>(TreeNode.Label.charexpr, null));
        parsingTable.put(new Pair<>(TreeNode.Label.expr, Token.TokenType.SQUOTE), exprRuleB);

        List<Pair<Symbol, Token.TokenType>> charexprRuleA = Arrays.asList(
        ...
        List<Pair<Symbol, Token.TokenType>> boolexprRuleA = Arrays.asList(
                new Pair<>(TreeNode.Label.boolop, null),
                new Pair<>(TreeNode.Label.relexpr, null),
                new Pair<>(TreeNode.Label.boolexpr, null));
        ...
        List<Pair<Symbol, Token.TokenType>> boollogRuleA = Collections.singletonList(new Pair<>(TreeNode.Label.terminal, Token.TokenType.AND));
        parsingTable.put(new Pair<>(TreeNode.Label.boollog, Token.TokenType.AND), boollogRuleA);

        List<Pair<Symbol, Token.TokenType>> boollogRuleB = Collections.singletonList(new Pair<>(TreeNode.Label.terminal, Token.TokenType.OR));
        parsingTable.put(new Pair<>(TreeNode.Label.boollog, Token.TokenType.OR), boollogRuleB);

        List<Pair<Symbol, Token.TokenType>> relexprRuleA = Arrays.asList(
                new Pair<>(TreeNode.Label.arithexpr, null),
                new Pair<>(TreeNode.Label.relexprprime, null));
        parsingTable.put(new Pair<>(TreeNode.Label.relexpr, Token.TokenType.LPAREN), relexprRuleA);
        ...
        List<Pair<Symbol, Token.TokenType>> relexprprimeRuleA = Arrays.asList(
                new Pair<>(TreeNode.Label.relop, null),
                new Pair<>(TreeNode.Label.arithexpr, null));
        ...
        List<Pair<Symbol, Token.TokenType>> relexprprimeRuleB = Collections.singletonList(new Pair<>(TreeNode.Label.epsilon, null));
        parsingTable.put(new Pair<>(TreeNode.Label.relexprprime, Token.TokenType.RPAREN), relexprprimeRuleB);
        ...
        List<Pair<Symbol, Token.TokenType>> arthiexprRuleA = Arrays.asList(
                new Pair<>(TreeNode.Label.term, null),
                new Pair<>(TreeNode.Label.arithexprprime, null));
        parsingTable.put(new Pair<>(TreeNode.Label.arithexpr, Token.TokenType.LPAREN), arthiexprRuleA);
        ...
        List<Pair<Symbol, Token.TokenType>> arithexprprimeRuleA = Arrays.asList(
                new Pair<>(TreeNode.Label.terminal, Token.TokenType.PLUS),
                new Pair<>(TreeNode.Label.term, null),
                new Pair<>(TreeNode.Label.arithexprprime, null));
        parsingTable.put(new Pair<>(TreeNode.Label.arithexprprime, Token.TokenType.PLUS), arithexprprimeRuleA);

        List<Pair<Symbol, Token.TokenType>> arithexprprimeRuleB = Arrays.asList(
                new Pair<>(TreeNode.Label.terminal, Token.TokenType.MINUS),
                new Pair<>(TreeNode.Label.term, null),
                new Pair<>(TreeNode.Label.arithexprprime, null));
        ...
        List<Pair<Symbol, Token.TokenType>> termRuleA = Arrays.asList(
        ...
        List<Pair<Symbol, Token.TokenType>> termprimeRuleA = Arrays.asList(
                new Pair<>(TreeNode.Label.terminal, Token.TokenType.TIMES),
                new Pair<>(TreeNode.Label.factor, null),
                new Pair<>(TreeNode.Label.termprime, null));
        parsingTable.put(new Pair<>(TreeNode.Label.termprime, Token.TokenType.TIMES), termprimeRuleA);

        List<Pair<Symbol, Token.TokenType>> termprimeRuleB = Arrays.asList(
                new Pair<>(TreeNode.Label.terminal, Token.TokenType.DIVIDE),
                new Pair<>(TreeNode.Label.factor, null),
                new Pair<>(TreeNode.Label.termprime, null));
        parsingTable.put(new Pair<>(TreeNode.Label.termprime, Token.TokenType.DIVIDE), termprimeRuleB);

        List<Pair<Symbol, Token.TokenType>> termprimeRuleC = Arrays.asList(
                new Pair<>(TreeNode.Label.terminal, Token.TokenType.MOD),
                new Pair<>(TreeNode.Label.factor, null),
                new Pair<>(TreeNode.Label.termprime, null));
        ...
        List<Pair<Symbol, Token.TokenType>> factorRuleA = Arrays.asList(
                new Pair<>(TreeNode.Label.terminal, Token.TokenType.LPAREN),
                new Pair<>(TreeNode.Label.arithexpr, null),
                new Pair<>(TreeNode.Label.terminal, Token.TokenType.RPAREN));
        parsingTable.put(new Pair<>(TreeNode.Label.factor, Token.TokenType.LPAREN), factorRuleA);
        ...
        parsingTable.put(new Pair<>(TreeNode.Label.factor, Token.TokenType.NUM), factorRuleB);

        List<Pair<Symbol, Token.TokenType>> factorRuleC = Collections.singletonList(new Pair<>(TreeNode.Label.terminal, Token.TokenType.ID));
        parsingTable.put(new Pair<>(TreeNode.Label.factor, Token.TokenType.ID), factorRuleC);

        List<Pair<Symbol, Token.TokenType>> printexprRuleA = Arrays.asList(
                new Pair<>(TreeNode.Label.relexpr, null),
                new Pair<>(TreeNode.Label.boolexpr, null));
        parsingTable.put(new Pair<>(TreeNode.Label.printexpr, Token.TokenType.LPAREN), printexprRuleA);
        ...
        List<Pair<Symbol, Token.TokenType>> printexprRuleB = Arrays.asList(
                new Pair<>(TreeNode.Label.terminal, Token.TokenType.DQUOTE),
                new Pair<>(TreeNode.Label.terminal, Token.TokenType.STRINGLIT),
                new Pair<>(TreeNode.Label.terminal, Token.TokenType.DQUOTE));
